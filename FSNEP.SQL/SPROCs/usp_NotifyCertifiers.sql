...
This is a reminder that, as a certifying supervisor, you have pending UC-CalFresh Nutrition Education Program time record certifications which are due by the 15th of this month.  Please access the UC-CalFresh Nutrition Education Program Online Time Record System to review and certify all submitted time records by the 15th of this month.
...
'
		...
		EXEC msdb.dbo.sp_send_dbmail
			@recipients=@Email,
			@subject='UC-CalFresh Nutrition Education Program Time Record Certifier reminder',
			@body=@bodyText
