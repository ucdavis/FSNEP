IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[udf_SumOfExpensesByMonth]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
	DROP FUNCTION [dbo].[udf_SumOfExpensesByMonth]
GO
...
GRANT SELECT ON [udf_SumOfExpensesByMonth] TO PUBLIC
